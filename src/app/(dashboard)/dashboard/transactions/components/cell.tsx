...
type Props = {
  row: Row;
  columnKey: Key;
  onAction: (id: string, action: 'update' | 'delete') => void;
};
...
export type Key = keyof Row | 'actions';
        ...
        <div className="relative flex items-center gap-2">
          <Tooltip content="Edit transaction">
            <span
              ...
              onClick={() => onAction(String(row.id), 'update')}
            >
              <EditIcon />
            </span>
          </Tooltip>
          ...
          <Tooltip color="danger" content="Delete">
            <span
              ...
              onClick={() => onAction(String(row.id), 'delete')}
            >
              <DeleteIcon />
            </span>
          </Tooltip>
